    ...
    <div style={{ display: "flex" }}>
      ...
      <div style={{ width: "100%", backgroundColor: "#fff" }}>
        ...
        <Infocard
          ...
          description="The operations dashboard provides a summary of each project's environments' status, including pipeline and alert statuses."
          primaryButton="Add projects"
          secondaryButton="View documentation"
          secondaryHref="https://docs.gitlab.com/ee/user/operations_dashboard/index.html"
          size="150px"
          sx={{ paddingTop: "30px" }}
        />
      </div>
